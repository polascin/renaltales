...
class Container_045afcb8d3 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_045afcb8d3 $container)
			{
	...
	public function createServiceContainer(): Container_045afcb8d3
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#^Function [a-zA-Z0-9\\\_]+\(\) should return .* but returns .*#'],
