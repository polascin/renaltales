...
class Container_6f532b6f83 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6f532b6f83 $container)
			{
	...
	public function createServiceContainer(): Container_6f532b6f83
	{
		return $this;
	}
